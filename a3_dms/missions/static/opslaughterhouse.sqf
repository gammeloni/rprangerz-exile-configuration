...
_msgStart = ['#FFFF00', "More than just animals are killed in this slaughterhouse, go stop the massacre..."];

// Define Mission Win message
_msgWIN = ['#0080ff',"RPRangerZ got rid of the wrongdoers at the slaughterhouse!"];

// Define Mission Lose message
_msgLOSE = ['#FF0000',"The massacre continues, the bandits will look for new victims..."];
