...
_msgWIN = ['#0080ff',"RPRangerZ have successfully killed the bandits and stolen all the cake :)"];

// Define Mission Lose message
_msgLOSE = ['#FF0000',"The bandits got bored and buggered off taking all the goodies..."];
