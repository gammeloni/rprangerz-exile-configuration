...
// New additional missions: abandoned village, stop the mayor, slaughterhouse
DMS_StaticMissionTypes append [["saltflats",1],["slums",1],["a_village",1],["mayor",1],["opslaughterhouse",1]];
...
DMS_BasesToImportOnServerStart append ["saltflatsbase","slums_objects","a_village_buildings","mayor_buildings","opslaughterhouse"];